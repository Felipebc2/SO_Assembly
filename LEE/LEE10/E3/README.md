...
diferentes a qual o conteúdo do arquivo password.txt é copiado para a primeira
alocação. De posse das informações referentes às alocações feitas pelo programa,
você poderá realizar a leitura do conteúdo da memória, a partir da segunda
